  ...
  const officialSources = [
    {
      ...
      description:"A comprehensive bill proposing the consolidation and reform of Nigeria’s major tax laws into a unified tax framework.",
      type: "Legislation",
      status: "Passed (Now Enacted as Nigeria Tax Act, 2025)"
    },
    {
